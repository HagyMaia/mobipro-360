    ...
    <div className="min-h-screen flex flex-col justify-between pb-24 font-sans select-none">
      ...
      <header className="sticky top-0 z-30 border-b border-gray-200 dark:border-dark-700 bg-white/90 dark:bg-dark-800/95 px-4 pb-3 pt-4 backdrop-blur-md">
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-emerald-500/15 text-emerald-400 font-bold border border-emerald-500/20">
      ...
      <main className="p-4 space-y-4 flex-1">
        ...
        {/* SOS BOTÃO DE PÂNICO */}
        <Card className="border-2 border-red-500/40 bg-gradient-to-b from-red-950/20 to-red-900/10 text-center p-6 rounded-3xl shadow-xl relative overflow-hidden">
          {sosTriggered ? (
            <div className="animate-in zoom-in-95 duration-200 space-y-3">
              ...
              <h2 className="text-xl font-black text-red-500">ALERTA SOS EMITIDO!</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-slate-100 text-sm">Botão de Emergência Rápida</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-xs font-bold text-gray-900 dark:text-slate-100">Gravação em Corrida</div>
              <div className="text-[10px] text-gray-500 dark:text-slate-400">Áudio & Telemetria</div>
            </Card>
            ...
            >
              ...
              <div className="text-xs font-bold text-gray-900 dark:text-slate-100">Compartilhar Rota</div>
              <div className="text-[10px] text-gray-500 dark:text-slate-400">Link seguro com família</div>
            </Card>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <a
              href="tel:190"
              className="flex items-center justify-between p-3 rounded-2xl bg-red-600/10 border border-red-500/25 text-red-400 hover:bg-red-600/20 transition"
            >
              <div className="flex items-center gap-2">
                <PhoneCall size={16} />
                <span className="font-extrabold text-xs">Polícia Militar</span>
              </div>
            ...
            >
              <div className="flex items-center gap-2">
                <PhoneCall size={16} />
                <span className="font-extrabold text-xs">SAMU Resgate</span>
              </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <SectionTitle className="text-xs font-bold text-gray-500 dark:text-slate-400">
            ...
            {state.contacts.map((contact) => (
              <Card key={contact.id} className="flex items-center justify-between p-3 border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-gray-900 dark:text-slate-100">{contact.name}</h4>
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="p-2 rounded-xl bg-emerald-500/15 text-emerald-400 hover:bg-emerald-500/25 transition"
                    title="Ligar"
                  >
                    <PhoneCall size={16} />
                  </a>
